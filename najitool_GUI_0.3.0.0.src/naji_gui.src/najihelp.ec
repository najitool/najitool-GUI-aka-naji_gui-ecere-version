...

{
...

    {
        ...
        true, // param 2 label
        true, // param 2 box
        "Makes a copy of a file with only the maximum specified extra newlines and skipping\n"
        "other newlines. Specify input file, output file, and maximum extra newlines.",

        "Max Ex Line:",
        "Parameter 2:",

        "Sadece maksimum belirtilen ekstra satirsonu karakterler ile, diger satirson karakterleri\n"
        "atlayarak bir dosyayi kopyalar. Okunan dosyayi, yazilan dosyayi,\nve maksimum satir sayisi belirt.",
